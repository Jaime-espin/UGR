...
void test_gestionarColisiones() {
  ...
  Particula p2(Vector2D(1, 2), Vector2D(0, 0), Vector2D(1, 2), 1.0, 0);
  Particula p3(Vector2D(1, 5), Vector2D(0, -1), Vector2D(0, 0), 1.0, 0);
  c.agregar(p1);
  c.agregar(p2);
  c.agregar(p3);
  c.obtener(2).mover();
  ...
  assert(c.obtener(1).getVelocidad().getX() ==  0.0);
  assert(c.obtener(1).getVelocidad().getY() ==  -1.0);
  assert(c.obtener(2).getVelocidad().getX() ==  0.0);
  assert(c.obtener(2).getVelocidad().getY() ==  0.0);

  assert(c.obtener(1).getAceleracion().getX() ==  0.0);
  assert(c.obtener(1).getAceleracion().getY() ==  0.0);
